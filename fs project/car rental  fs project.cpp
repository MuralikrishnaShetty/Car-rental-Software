...
class rent : public customer // inhereted class from customer class
{
    ...
    do
    {
        ...
        cout<<"\t\t\t\tEnter 'A' for Maruthi suzuki 20011."<<endl;
        cout<<"\t\t\t\tEnter 'B' for Hyundai i20 2015."<<endl;
        cout<<"\t\t\t\tEnter 'C' for Ford ecosport"<<endl;
        cout<<endl;
 ...
 if(carmodel=="A")
 {
 	system("CLS");
		...
		cout<<"You have choosed Maruthi suzuki 2011"<<endl;
...
sleep(2);
  ...
  if(carmodel=="B")
  {
  	system("CLS");
		...
		cout<<"You have choosed Hyundai i20 2015"<<endl;
 ...
 {
 	system("CLS");
	     cout<<"You have choosed Ford ecosport 2017"<<endl;
...
void rent::addnew(){
	fstream outin;
	outin.open("carent.txt",ios::app|ios::out);
	showrent();
	outin.write((char*)this,sizeof(rent));
	cout<<"your data  inserted"<<endl;
	getch();
	outin.close();
...
int login(){
   ...
   cout<<"\n\t\t\t\t\t\t     LOGIN \n";	
   cout<<"\t\t\t\t\t------------------------------\n\n";
   cout<<"\t\t\t\t\t|User:Muralikrishna and Chetan k\n";
   cout << "\t\t\t\t\t|Enter Password: |";
   ch = _getch();
